...
const start = async () => {
  ...
  const clientCompiler: any = multiCompiler.compilers.find(compiler => compiler.name === 'client');
  const serverCompiler: any = multiCompiler.compilers.find(compiler => compiler.name === 'server');
